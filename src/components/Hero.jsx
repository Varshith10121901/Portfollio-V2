      ...
      >
        ...
        <motion.div className="hero-actions" variants={itemVariants}>
          <div className="swarm-btn-wrapper">
            <a href="https://stadium-swarmai.azurewebsites.net/dashboard" target="_blank" rel="noreferrer" className="google-sweep-btn">
            ...
            <div className="swarm-hover-card" style={{ right: 'auto', left: '0' }}>
